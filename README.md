...
**215 categorized skills · lightweight selective install · compact TOON catalog · cross-platform**
...
Install the **`jeo-skill` router first**, not all 215 skill folders. It provides category,
...
> Central manifest: `.agent-skills/skills.json` · 215 skills · 10 primary categories · subcategory/interface/relationship metadata
