...
> Full manifest: `.agent-skills/skills.json` · each folder's `SKILL.md` · 93 local skill folders = 90 total installable skills
...
```text
.
├── .agent-skills/          ← 93 skill folders (each with SKILL.md + SKILL.toon)
