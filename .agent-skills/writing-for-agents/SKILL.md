...
compatibility: >
  Upstream replacement for the retired write-a-skill skill. Route spec compliance checks to skill-
  standardization and quality ratcheting to skill-autoresearch.
metadata:
  tags: skill-writing, agents-md, claude-md, skill-mechanics, agent-prose
...
When the document you're writing is a skill, read [`references/SKILL-MECHANICS.md`](SKILL-MECHANICS.md) for frontmatter, invocation choice, and router skills.
...
- **By invocation**, skill-specific: see [`references/SKILL-MECHANICS.md`](SKILL-MECHANICS.md).
...
- Upstream skill: `mattpocock/skills` `skills/productivity/writing-for-agents/SKILL.md` (commit `3cca18b`, MIT)
- Companion doc: [references/SKILL-MECHANICS.md](references/SKILL-MECHANICS.md)
