...
description: >
  Turn a decision you can't fully answer into a questionnaire for someone else to fill in. Use
  when a decision needs another person's input before it can be settled. Triggers on: to-
  questionnaire, make this a questionnaire, ask them these questions.
allowed-tools: Read Grep Glob Write
compatibility: >
  For decisions you cannot answer alone and must delegate. Route interactive stress-testing to
  grilling and spec synthesis to to-spec.
metadata:
  tags: questionnaire, delegated-decision, open-questions, stakeholder-input, decision-capture
...
Turn a decision you can't fully answer into a questionnaire for someone else to fill in. Use when a decision needs another person's input before it can be settled. Triggers on: to-questionnaire, make this a questionnaire, ask them these questions.
...
- Use when a decision needs another person's input before it can be settled.
- Triggers on: to-questionnaire, make this a questionnaire, ask them these questions.
...
- Upstream skill: `mattpocock/skills` `skills/productivity/to-questionnaire/SKILL.md` (commit `3cca18b`, MIT)
