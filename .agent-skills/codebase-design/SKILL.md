...
compatibility: >
  Shared vocabulary layer. Pairs with improve-codebase-architecture for scanning and code-
  refactoring for behavior-preserving cleanup.
metadata:
  tags: deep-modules, seams, testability, interface-design, design-it-twice
...
- Upstream skill: `mattpocock/skills` `skills/engineering/codebase-design/SKILL.md` (commit `3cca18b`, MIT)
- Companion doc: [references/DEEPENING.md](references/DEEPENING.md)
- Companion doc: [references/DESIGN-IT-TWICE.md](references/DESIGN-IT-TWICE.md)
