...
description: >
  Implement, tune, debug, or validate soft wall-aware fog of war and gameplay perception in
  Three.js action games. Use for orthographic or isometric visibility masks, obstacle-aware line
  of sight, player and enemy vision ranges, hidden-enemy targeting rules, fog shader artifacts
  such as spokes or seams, mobile ray budgets, lifecycle and menu-state integration, and
  deterministic fog-of-war tests.
...
license: MIT
metadata:
  tags: implement, fog, war, mengto-skills, codex-workflow
  version: "1.0"
...
- Not for general Three.js game architecture, rendering, or physics unrelated to fog/perception — route that to this repo's `web-game-development` pack instead.
...
- Upstream source: [MengTo/Skills — implement-fog-of-war](https://github.com/MengTo/Skills/tree/main/agent-skills/codex/implement-fog-of-war)
