...
description: >
  ...
  ticket locally, or native blocking links on a real tracker). Use when a plan or spec should
  become executable work items. Triggers on: to-tickets, to-issues, to-plan, break this into
  tickets.
allowed-tools: Read Grep Glob Bash Write Edit
compatibility: >
  Replaces the retired to-issues and to-plan skills. Route spec writing to to-spec, sizing to
  task-estimation, and issue-state governance to triage.
metadata:
  tags: tracer-bullets, vertical-slices, wide-refactor, blocking-edges, issue-tracker
...
- Use when a plan or spec should become executable work items.
- Triggers on: to-tickets, to-issues, to-plan, break this into tickets.
...
- Upstream skill: `mattpocock/skills` `skills/engineering/to-tickets/SKILL.md` (commit `3cca18b`, MIT)
