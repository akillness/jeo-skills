...
description: >
  ...
  interview, just synthesis of what you've already discussed. Use when the conversation is ready
  to become a written spec. Triggers on: to-spec, to-prd, write this up as a spec.
allowed-tools: Read Grep Glob Bash Write Edit
compatibility: >
  Replaces the retired to-prd skill. Synthesises the current conversation with no interview. Route
  slicing into work items to to-tickets.
metadata:
  tags: spec, prd, issue-tracker, conversation-synthesis, no-interview
...
- Use when the conversation is ready to become a written spec.
- Triggers on: to-spec, to-prd, write this up as a spec.
...
- Upstream skill: `mattpocock/skills` `skills/engineering/to-spec/SKILL.md` (commit `3cca18b`, MIT)
