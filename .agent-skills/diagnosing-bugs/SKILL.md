...
compatibility: >
  Replaces the retired diagnose skill. Route broad root-cause workflow design to debugging and
  profiler capture reading to performance-optimization.
metadata:
  tags: debugging, diagnosis-loop, performance-regression, hitl-loop, feedback-loop
...
- Upstream skill: `mattpocock/skills` `skills/engineering/diagnosing-bugs/SKILL.md` (commit `3cca18b`, MIT)
- Script: `scripts/hitl-loop.template.sh`
