...
description: >
  ...
  Use when this repo has not yet been configured for the suite. Triggers on: setup-matt-pocock-
  skills, configure the issue tracker, set up triage labels.
allowed-tools: Read Grep Glob Bash Write Edit
compatibility: >
  Run once per repo before the other suite skills. Route agent documentation scaffolding to
  deepinit and skill installation to find-skills.
metadata:
  tags: repo-configuration, issue-tracker, triage-labels, domain-docs, one-time-setup
...
- Use when this repo has not yet been configured for the suite.
- Triggers on: setup-matt-pocock-skills, configure the issue tracker, set up triage labels.
...
- Upstream skill: `mattpocock/skills` `skills/engineering/setup-matt-pocock-skills/SKILL.md` (commit `3cca18b`, MIT)
- Companion doc: [references/domain.md](references/domain.md)
- Companion doc: [references/issue-tracker-github.md](references/issue-tracker-github.md)
- Companion doc: [references/issue-tracker-gitlab.md](references/issue-tracker-gitlab.md)
- Companion doc: [references/issue-tracker-local.md](references/issue-tracker-local.md)
- Companion doc: [references/triage-labels.md](references/triage-labels.md)
