...
description: >
  ...
  if needed, and write agent-ready briefs. Use when issues or external PRs need categorising,
  verifying, and turning into agent-ready briefs. Triggers on: triage, triage the backlog, review
  these issues.
allowed-tools: Read Grep Glob Bash Write Edit
compatibility: >
  Moves issues and external PRs through triage roles. Route backlog decomposition to to-tickets
  and estimation to task-estimation.
metadata:
  tags: triage-roles, state-machine, agent-brief, issue-categorisation, external-prs
...
Move issues and external PRs through a state machine of triage roles, categorise, verify, grill if needed, and write agent-ready briefs. Use when issues or external PRs need categorising, verifying, and turning into agent-ready briefs. Triggers on: triage, triage the backlog, review these issues.
...
- Use when issues or external PRs need categorising, verifying, and turning into agent-ready briefs.
- Triggers on: triage, triage the backlog, review these issues.
...
- Upstream skill: `mattpocock/skills` `skills/engineering/triage/SKILL.md` (commit `3cca18b`, MIT)
- Companion doc: [references/AGENT-BRIEF.md](references/AGENT-BRIEF.md)
- Companion doc: [references/OUT-OF-SCOPE.md](references/OUT-OF-SCOPE.md)
