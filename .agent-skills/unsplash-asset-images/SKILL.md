...
description: >
  Use when you need to pick high-quality Unsplash images for product/design assets (avatars,
  headshots, portraits, large website backgrounds, and abstract wallpapers) and output real
  Unsplash URLs plus practical instructions for producing the right resolutions and aspect
...
license: MIT
metadata:
  tags: unsplash, asset, images, mengto-skills, stock-images, design-assets
  version: "1.0"
  source: https://github.com/MengTo/Skills/tree/main/agent-skills/media/unsplash-asset-images
---
...
- Need a real Unsplash photo page URL (not a placeholder) for an avatar, headshot, portrait, hero background, or abstract wallpaper.
- Need the recommendation delivered with suggested output ratios/sizes (1:1, 4:5, 3:4, 16:9, 9:16) for a specific use case.
- Need guidance on downloading and cropping/resizing an Unsplash photo for a design or image pipeline.
- Need a quick "which ratio do I use?" decision for avatars, headshot cards, hero backgrounds, or mobile wallpapers.
- Need reminders on Unsplash licensing/attribution norms (e.g., avoiding Unsplash+ unless requested).
- Don't use this for Aura Assets (aura.build/assets) searches — route to `aura-asset-images` instead, which searches Aura's own asset library by tag rather than Unsplash.
...
- Upstream source: https://github.com/MengTo/Skills/tree/main/agent-skills/media/unsplash-asset-images
