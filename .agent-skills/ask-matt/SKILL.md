...
name: ask-matt
description: >
  Ask which skill or flow fits your situation. A router over the skills in this repo. Use when the
  user asks which of these engineering skills or flows fits their situation. Triggers on: ask-
  matt, which skill should I use, what flow fits here.
allowed-tools: Read Grep Glob
compatibility: >
  Routes only inside the mattpocock/skills suite. For catalog-wide discovery use jeo-skill, find-
  skills, or openspace.
metadata:
  tags: skill-routing, workflow-selection, phase-boundaries, engineering-flow, suite-router
...
Ask which skill or flow fits your situation. A router over the skills in this repo. Use when the user asks which of these engineering skills or flows fits their situation. Triggers on: ask-matt, which skill should I use, what flow fits here.
...
- Use when the user asks which of these engineering skills or flows fits their situation.
- Triggers on: ask-matt, which skill should I use, what flow fits here.
...
- Upstream skill: `mattpocock/skills` `skills/engineering/ask-matt/SKILL.md` (commit `3cca18b`, MIT)
- Companion doc: [references/PHASE-BOUNDARIES.md](references/PHASE-BOUNDARIES.md)
