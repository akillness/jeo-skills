...
name: prototype
description: >
  Build a throwaway prototype to answer a design question. Use when the user wants to sanity-check
  whether a state model or logic feels right, or explore what a UI should look like.
allowed-tools: Read Grep Glob Bash Write Edit
compatibility: >
  For disposable exploration that answers one design question. Route production implementation to
  implement and durable architecture decisions to codebase-design.
metadata:
  tags: throwaway-prototype, design-question, state-model, ui-exploration, spike
...
- Upstream skill: `mattpocock/skills` `skills/engineering/prototype/SKILL.md` (commit `3cca18b`, MIT)
- Companion doc: [references/LOGIC.md](references/LOGIC.md)
- Companion doc: [references/UI.md](references/UI.md)
