...
def main():
    ...
    run(["python3", os.path.join(scripts, "validate_hourly_evidence_contract.py"), evidence])
    run(["python3", os.path.join(scripts, "validate_lane_metric_integrity.py"), evidence, os.path.join(survey_dir, "lane-metric-integrity.json")])
    run(["python3", os.path.join(scripts, "collect_lane_recovery_coverage.py"), evidence, os.path.join(survey_dir, "recovery-stage-coverage.json")])
