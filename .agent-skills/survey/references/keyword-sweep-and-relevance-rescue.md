...
- Enforce lane-metric integrity before writing artifacts: `kept_count` must never exceed `raw_count`; recompute both from the same selected set after recovery-query switches.
