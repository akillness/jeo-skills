...
metadata:
  tags: content-moderation, social-media, publish-precheck, chinese-platforms
  version: "1.0.0"
  source: yuwen-cool/yuwen-publish-precheck
---
...
## When to use this skill｜用户怎么说，你怎么做
...
- 用户说“审一下这篇口播稿能不能发抖音”：先确认平台、商业属性和行业，再执行 `python3 scripts/scan.py --file <稿件>`，按规则引用位置并给逐平台结论。
- 用户说“帮我改成小红书能发的版本”：先完成审查再按 `references/repair.md` 最小改写，随后重跑扫描和语义复检，输出可直接替换的稿件。
