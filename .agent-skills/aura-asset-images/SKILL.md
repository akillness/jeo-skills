...
description: >
  Use when you need high-quality stock-style images from Aura Assets (aura.build/assets) similar
  to Unsplash for design mockups and marketing: backgrounds, abstract wallpapers, architecture,
  portraits, and headshots. Includes a workflow for searching by tag on aura.build/assets and
  returns 5 real image URLs per category plus practical guidance for using different resolutions
  and aspect ratios.
allowed-tools: Bash Read Write Edit Glob Grep WebFetch
compatibility: Needs web access to browse the asset library and return real image URLs. No local dependencies.
license: MIT
metadata:
  tags: aura, asset, images, mengto-skills, stock-images, design-assets
  version: "1.0"
  source: https://github.com/MengTo/Skills/tree/main/agent-skills/media/aura-asset-images
---
...
- Upstream source: https://github.com/MengTo/Skills/tree/main/agent-skills/media/aura-asset-images
