...
name: teach
description: >
  Teach the user a new skill or concept, within this workspace. Use when the user wants to learn a
  concept or skill inside this workspace. Triggers on: teach me, help me learn, explain this
  properly.
allowed-tools: Read Grep Glob Write Edit
compatibility: >
  Runs a workspace-scoped learning session with persistent records. Route audience-level
  explanation to eli5 and confusion recovery to wait-what.
metadata:
  tags: teaching, learning-record, mission, glossary, workspace-learning
...
- Use when the user wants to learn a concept or skill inside this workspace.
- Triggers on: teach me, help me learn, explain this properly.
...
- Upstream skill: `mattpocock/skills` `skills/productivity/teach/SKILL.md` (commit `3cca18b`, MIT)
- Companion doc: [references/GLOSSARY-FORMAT.md](references/GLOSSARY-FORMAT.md)
- Companion doc: [references/LEARNING-RECORD-FORMAT.md](references/LEARNING-RECORD-FORMAT.md)
- Companion doc: [references/MISSION-FORMAT.md](references/MISSION-FORMAT.md)
- Companion doc: [references/RESOURCES-FORMAT.md](references/RESOURCES-FORMAT.md)
