...
**127개 로컬 스킬 폴더 · 설치 가능 스킬 126개 · TOON 포맷 · 멀티플랫폼**
...
Agent Skills는 LLM 기반 개발 워크플로우를 위한 컬렉션으로, 현재 127개 로컬 스킬 폴더와 126개 설치 가능 스킬을 제공합니다. `jeo` 오케스트레이션 프로토콜을 중심으로 구축되었으며 다음을 제공합니다:
