...
- `plannotator` — review and approval of concrete plans, markdown artifacts, or diffs
...
3. keep `plannotator` scoped to concrete plan/spec/diff review packets, with manual-vs-hook reality explained honestly per platform
