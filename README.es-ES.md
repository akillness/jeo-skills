...
[![Skills](https://img.shields.io/badge/Skills-233-blue?style=for-the-badge)](https://github.com/akillness/jeo-skills)
...
**233 habilidades categorizadas · instalación selectiva ligera · catálogo TOON compacto · multiplataforma**
...
Instala primero el **enrutador `jeo-skill`**, no las 233 carpetas de habilidades. Proporciona descubrimiento de categoría, subcategoría, interfaz, paquete y relación, manteniendo aplicaciones pesadas, modelos, servidores MCP y tiempos de ejecución bajo demanda.
...
> Manifiesto central: `.agent-skills/skills.json` · 233 habilidades · 10 categorías principales · metadatos de subcategoría/interfaz/relación
...
### ⌨️ Herramientas CLI (32)

Subcategorías: `developer-cli` (8), `ai-cli` (11), `media-cli` (1), `automation-cli` (6), `search-cli` (5), `benchmark-cli` (1)
...
```text
.
├── .agent-skills/          ← 233 skill folders (SKILL.md + optional support files)
