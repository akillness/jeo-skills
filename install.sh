...
# Usage: curl -fsSL https://raw.githubusercontent.com/akillness/jeo-skills/main/install.sh | bash
#
...
#     curl -fsSLO https://raw.githubusercontent.com/akillness/jeo-skills/main/install.sh
